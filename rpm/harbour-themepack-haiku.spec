...
License:        GPLv3
Packager:       fravaccaro
URL:            https://github.com/uithemer/harbour-themepack-haiku
Source0:        %{name}-%{version}.tar.bz2
Source100:      harbour-themepack-haiku.yaml
...
%description
Haiku theme pack for Sailfish OS — DejaVu Sans fonts and Haiku-style icons for Muoto.
